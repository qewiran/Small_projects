...
double Power_Method::GetMaxEigenValue()
{
    return this->maxEigenValue;
}

double Power_Method::GetMinEigenValue()
{
...
void Power_Method::ReverseMethod(const Matrix &y_0, const double sigma)
{
    ...
    std::cout << sum_lambda / (double)card_I + sigma << " iterations: " << iterations << '\n';
}
