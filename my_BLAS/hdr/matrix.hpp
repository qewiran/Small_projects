...
public:
  ...
  // explanation: when a custom constructor is created, no default constructor
  // is generated by the compiler, default cont-r looks like this:
  //
  // Matrix() {}
  //
  // all class members are initialised by default, unless otherwise specified
  // in this class zero-initialization is used, so it is equal to
  //
  // Matrix(): data{}, rank{}  {}
  //
  // if needed this may be helpful to initialize matrix class with an array like
  // this:
  //
  // Matrix(const std::array<Field, ROWS * COLUMNS>& otherData)
  //     : data(otherData) {}
  //
  //  but then there would be need to define default constructor because it
  //  won't be generated by compiler
